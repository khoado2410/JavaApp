...
public class editFoodForm extends JFrame implements ActionListener{
	...
	public editFoodForm(String id, String name, String price1, String amount) {
		...
		formTitle = new JLabel("Form Edit");
		...
		this.controller.getAllNameFoodTypeToComboboxEditForm();
